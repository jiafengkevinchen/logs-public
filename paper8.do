...
use _output/paper8.dta, clear

local paper8_original_command "$paper8_command_start $paper8_arcsinh_var $paper8_command_end"

`paper8_original_command'
display _b["$paper8_main_xvar"]
